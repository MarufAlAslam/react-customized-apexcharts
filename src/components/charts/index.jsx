        ...
        <div className="lg:w-[55%] rounded-[3px] flex justify-between items-start w-full text-white bg-black p-4">
          ...
          <div className="vals w-[20%]">
            <div className="header flex justify-between items-center">
              ...
              <div onClick={handleStarClick} className="h-[45px] rounded bg-[#292E32] ml-2 p-2 min-w-[45px] flex justify-center items-center">
                <IoStarSharp className={`m-auto text-3xl  ${active ? 'text-[#F7B84B]' : 'text-[#7F7F7F]' }`} />
              </div>
            </div>
